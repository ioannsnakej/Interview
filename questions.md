...
<summary>Docker</summary>
  ...
  <details>
    <summary>Ответ</summary>
  По умолчанию Docker использует root (UID 0). Если контейнер будет скомпрометирован, то злоумышлиник может получить доступ ко всему хосту (побег из контейнера)
  </details>
</details>